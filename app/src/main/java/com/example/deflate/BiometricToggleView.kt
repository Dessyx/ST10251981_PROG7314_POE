...
class BiometricToggleView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        inflater.inflate(R.layout.view_biometric_toggle, this, true)

        track = findViewById(R.id.biometric_track)
        thumb = findViewById(R.id.biometric_thumb)
        thumbText = findViewById(R.id.biometric_thumb_text)
        ...
        isClickable = true
        isFocusable = true
        contentDescription = "Biometrics toggle"
    ...
    fun setChecked(checked: Boolean, animate: Boolean = true) {
        ...
        contentDescription = "Biometrics ${if (_isChecked) "On" else "Off"}"
    }
